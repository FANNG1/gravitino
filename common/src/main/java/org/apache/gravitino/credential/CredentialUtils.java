...
public class CredentialUtils {
  private static Map<String, String> icebergCredentialPropertyMap =
      ImmutableMap.of(
          ...
          S3Properties.GRAVITINO_S3_TOKEN, IcebergConstants.ICEBERG_S3_TOKEN, GCSProperties.GRAVITINO_GCS_TOKEN, IcebergConstants.ICEBERG_GCS_TOKEN, GCSProperties.GRAVITINO_TOKEN_EXPIRE_MS, IcebergConstants.ICEBERG_GCS_TOKEN_EXPIRES_AT);

  public static Map<String, String> toIcebergProperties(Credential credential) {
    if (credential instanceof S3TokenCredential || credential instanceof S3SecretKeyCredential || credential instanceof GcsTokenCredential) {
