...
public class DummyTableStatisticsComputer implements SupportsCalculateTableStatistics {
  ...
  public TableStatisticsBundle calculateTableStatistics(NameIdentifier tableIdentifier) {
    List<StatisticEntry<?>> tableStatistics =
        Arrays.asList(new StatisticEntryImpl(TABLE_STAT_NAME, StatisticValues.longValue(1L)));
  ...
  public static List<PartitionEntry> getPartitionName() {
    return Arrays.asList(new PartitionEntryImpl("p1", "v1"));
  }
}
