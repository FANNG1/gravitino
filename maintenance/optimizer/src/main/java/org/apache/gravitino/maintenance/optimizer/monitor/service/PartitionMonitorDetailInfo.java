...
public class PartitionMonitorDetailInfo extends TableMonitorDetailInfo {
  public final String partitionPath;

  public PartitionMonitorDetailInfo(
    ...
    super(tableIdentifier, actionTimeSeconds, rangeSeconds, state, beforeMetrics, afterMetrics);
