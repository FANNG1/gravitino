...
public class TableMonitorDetailInfo extends MonitorDetailInfo {
  public final String tableIdentifier;
  public final long actionTimeSeconds;
  public final long rangeSeconds;

  public TableMonitorDetailInfo(
    ...
    super(beforeMetrics, afterMetrics, state);
