...
public interface SupportsCalculateJobStatistics extends StatisticsCalculator {
   ...
   */
  default Map<NameIdentifier, List<StatisticEntry<?>>> calculateAllJobStatistics() {
    throw new UnsupportedOperationException("Bulk job statistics computation not supported");
  }
}
