...
public class MonitorDetailInfo {
  public final Map<String, List<MetricSample>> beforeMetrics;
  public final Map<String, List<MetricSample>> afterMetrics;
  public final MonitorRequestState state;

  public MonitorDetailInfo(
