...
public class CliStatisticsCalculator
  ...
  public void initialize(OptimizerEnv optimizerEnv) {
    ...
    Preconditions.checkArgument(
        ...
        "StatisticsCalculatorContent is required for CliStatisticsCalculator");
    String statisticsPayload = ((StatisticsCalculatorContent) content).statisticsPayload();
    Preconditions.checkArgument(
