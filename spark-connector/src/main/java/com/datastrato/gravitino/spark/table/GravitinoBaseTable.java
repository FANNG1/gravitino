...
/**
 * Provides schema info from Gravitino, IO from the internal spark table. The specify catalog table
...
public class GravitinoBaseTable implements Table, SupportsRead, SupportsWrite {
  ...
  public Map<String, String> properties() {
    ...
    properties = propertiesConverter.fromGravitinoTableProperties(properties);
